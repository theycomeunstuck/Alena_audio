# Legacy: JSON / JSONB в PostgreSQL-векторной базе

> В текущей архитектуре не используйте этот путь: профили и учебные материалы
> остаются JSON-файлами. JSONB нужен только при включённом PostgreSQL. Этот
> документ сохранён как справка для будущей миграции, а не как инструкция запуска.
