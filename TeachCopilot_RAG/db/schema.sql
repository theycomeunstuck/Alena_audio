...
CREATE TABLE IF NOT EXISTS child_profiles (
    ...
    avg_response_time_sec REAL,   -- used by prompt_builder / db.get_child_full_profile
...
CREATE TABLE IF NOT EXISTS knowledge_base (
    ...
    difficulty          VARCHAR(50), -- used by rag.search_knowledge filter + ingest_json
    tags                TEXT[],      -- used by rag.search_knowledge filter + ingest_json
